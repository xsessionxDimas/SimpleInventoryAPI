...
var supplierfunc = function () {
            ...
            columns: [
                {
                    ...
                    template: function (row) {
                        return '\
                        <button onclick="supplierfunc.item(' + row.id + ');" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
    ...
    var generateTable   = function () {
        /* api call here */
        var settings = {
            "url"       : HOST_URL + '/api/Supplier/GetList',
            "method"    : "GET",
            "timeout"   : 0,
            "headers"   : {
    ...
    var updateSupplier = function () {
        ...
        /* api call here */
        var settings = {
            "url"       : HOST_URL + '/api/Supplier/Update',
            "method"    : "PUT",
            "timeout"   : 0,
            "headers"   : {
                "Content-Type"  : "application/json",
